...
C++ for static and Javascript for dynamic. i use those thing for studies.
so that i can study more app because the resources needed to learn varies in different languages.
Golangg and javascriot for webdev,  C++ for embedded, Java and python(kivy) for mobile, C# andd Xojo for IOT.
